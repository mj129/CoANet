...
class Segmentation(Dataset):
    ...
    def __init__(self,
        ...
        self._cat_dir = os.path.join(self._base_dir, 'train')
    ...
    def _make_img_gt_point_pair(self, index):
        ...
        _connect_d1_0 = Image.open(self.connect_d1_label[index] + '_mask' + '_0.png').convert('RGB')
        _connect_d1_1 = Image.open(self.connect_d1_label[index] + '_mask' + '_1.png').convert('RGB')
        _connect_d1_2 = Image.open(self.connect_d1_label[index] + '_mask' + '_2.png').convert('RGB')
